...
public class DotsProvider extends ContentProvider {
	...
	static final String DOT_CONTENT_TYPE = "vnd.android.cursor.dir/vnd." + AUTHORITY + "." + DOTS_PATH;
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		if (cursor != null)
			cursor.setNotificationUri(getContext().getContentResolver(), DOTS_CONTENT_URI);
		return cursor;
	}
	...
	private static class DBHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			db.execSQL("create table " + TABLE_DOTS + " (" + COLUMN_ID + " integer primary key autoincrement," + COLUMN_NAME + " text," + COLUMN_GEO_LOCATION
